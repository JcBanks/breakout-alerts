...
# import streamlit as st
# from pages.etf_breakout_monitor import etf_breakout_monitor
...
#             st.session_state["page"] = "ETF Breakout Monitor"

# # Navigation logic
# if st.session_state["page"] == "Home":
#     home_page()
# elif st.session_state["page"] == "ETF Breakout Monitor":
#     etf_breakout_monitor()
